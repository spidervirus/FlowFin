...
const categoryKeywords: Record<string, string[]> = {
  "Groceries": ["grocery", "supermarket", "food", "market", "walmart", "kroger", "safeway", "trader joe", "whole foods", "aldi", "publix", "costco", "target"],
  "Dining": ["restaurant", "cafe", "coffee", "starbucks", "mcdonald", "burger", "pizza", "taco", "sushi", "dining", "doordash", "ubereats", "grubhub", "seamless"],
  "Transportation": ["uber", "lyft", "taxi", "cab", "transit", "subway", "metro", "bus", "train", "gas", "fuel", "parking", "toll"],
  "Housing": ["rent", "mortgage", "apartment", "condo", "house", "property", "real estate", "hoa", "maintenance"],
  "Utilities": ["electric", "water", "gas", "internet", "cable", "phone", "utility", "bill", "at&t", "verizon", "comcast", "xfinity"],
  "Entertainment": ["movie", "theater", "cinema", "concert", "show", "netflix", "hulu", "spotify", "disney", "amazon prime", "hbo", "ticket"],
  "Shopping": ["amazon", "ebay", "etsy", "walmart", "target", "best buy", "clothing", "apparel", "shoes", "electronics", "furniture", "home goods"],
  "Health": ["doctor", "hospital", "clinic", "medical", "dental", "pharmacy", "prescription", "insurance", "healthcare", "fitness", "gym"],
  "Education": ["school", "college", "university", "tuition", "course", "class", "book", "textbook", "education", "student", "loan"],
  "Travel": ["hotel", "airbnb", "flight", "airline", "vacation", "trip", "travel", "booking", "expedia", "airfare", "cruise"],
  "Subscriptions": ["subscription", "membership", "monthly", "annual", "recurring", "netflix", "spotify", "apple", "google", "amazon prime"],
  "Income": ["salary", "paycheck", "deposit", "direct deposit", "payment", "income", "revenue", "wage", "commission", "bonus", "refund"],
  "Investments": ["investment", "stock", "bond", "mutual fund", "etf", "dividend", "interest", "capital gain", "robinhood", "fidelity", "vanguard", "schwab"],
  "Insurance": ["insurance", "premium", "coverage", "policy", "life insurance", "auto insurance", "home insurance", "health insurance"],
  "Taxes": ["tax", "irs", "federal", "state", "property tax", "income tax", "sales tax"],
  "Gifts & Donations": ["gift", "donation", "charity", "nonprofit", "gofundme", "patreon", "kickstarter"],
  "Business": ["business", "office", "supplies", "equipment", "software", "service", "contractor", "client", "customer", "vendor"],
};

// Simple ML model based on keyword matching and frequency analysis
export function suggestCategory(description: string, amount: number, type: string, previousTransactions: Transaction[], categories: Category[]): string | null {
  ...
  if (bestMatch) {
    ...
    const matchedCategory = categories.find(
      c => c.name.toLowerCase() === bestMatch?.toLowerCase() && c.type === type
    );
  ...
  if (type === "income") {
    ...
    const generalCategory = categories.find(
      c => (c.name.toLowerCase() === "uncategorized" || c.name.toLowerCase() === "other") && c.type === "expense"
    );
    if (generalCategory) {
