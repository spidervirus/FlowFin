...
const TAX_DEADLINES: Record<
  string,
  { name: string; deadline: string; fiscalYear: string }
> = {
  US: {
    name: "United States",
    deadline: "April 15",
...
const TAX_RATES: Record<string, Array<{ bracket: number; rate: number }>> = {
  ...
  UK: [
    { bracket: 0, rate: 0.0 },
    { bracket: 12570, rate: 0.2 },
    { bracket: 50270, rate: 0.4 },
...
export default function TaxPreparation({
  ...
  const [taxDeductibleTransactions, setTaxDeductibleTransactions] = useState<
    Transaction[]
  >([]);
      ...
      if (nextBracket) {
        ...
        if (income > nextBracket.bracket) {
          const taxableInThisBracket =
            nextBracket.bracket - currentBracket.bracket;
  ...
  const exportTaxReport = () => {
    try {
      ...
      link.setAttribute(
        "download",
        `tax_report_${new Date().getFullYear()}.csv`,
      );
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-medium text-blue-800 mb-1">
              Tax Preparation for {taxInfo.name}
            </h3>
            <p className="text-sm text-blue-700">
              File your taxes by <strong>{taxInfo.deadline}</strong> for the
              fiscal year {taxInfo.fiscalYear}.
            </p>
          </div>
        </div>
        ...
        <CardContent className="p-6">
          ...
          <div className="flex justify-between items-center">
            <span className="text-sm text-gray-500">
              Filing Deadline: {taxInfo.deadline}
            </span>
            ...
            <CardContent className="p-6 space-y-6">
              ...
              {missingCategories > 0 && (
                <Alert className="bg-yellow-50 border-yellow-200">
                  ...
                  <AlertDescription>
                    You have {missingCategories} expense transactions without
                    categories. Categorizing these may help identify additional
                    tax deductions.
                  </AlertDescription>
                </Alert>
              )}
              ...
              <Alert className="bg-amber-50 border-amber-200">
                ...
                <AlertDescription>
                  This is an estimate based on your transaction data. Consult
                  with a tax professional for accurate tax calculations and
                  filing advice for {taxInfo.name}.
                </AlertDescription>
              </Alert>
            ...
            <CardContent className="p-6">
              ...
              {quarterlyData.length > 0 ? (
                <div>
                  ...
                  <div className="border-x border-b rounded-b-lg divide-y">
                    {quarterlyData.map((quarter) => (
                      <div
                        key={quarter.quarter}
                        className="grid grid-cols-5 p-3 text-sm hover:bg-gray-50"
                      >
                        ...
                        <div className="col-span-1 text-right text-green-600">
                          {formatCurrency(quarter.deductible)}
                        </div>
                        <div className="col-span-1 text-right font-medium">
                          {formatCurrency(quarter.taxable)}
                        </div>
                      </div>
                    ))}
                    ...
                    <div className="grid grid-cols-5 p-3 bg-gray-50 font-medium">
                      ...
                      <div className="col-span-1 text-right">
                        {formatCurrency(
                          taxDeductibleAmount + nonDeductibleAmount,
                        )}
                      </div>
                      <div className="col-span-1 text-right text-green-600">
                        {formatCurrency(taxDeductibleAmount)}
                  ...
                  <div className="mt-6">
                    <Alert className="bg-blue-50 border-blue-200">
                      ...
                      <AlertDescription>
                        {countryCode === "US" ? (
                          <p>
                            Consider making quarterly estimated tax payments to
                            avoid penalties. For self-employed individuals,
                            quarterly tax payments are typically due on April
                            15, June 15, September 15, and January 15.
                          </p>
                        ) : (
                          <p>
                            Check if {taxInfo.name} requires periodic tax
                            payments throughout the year to avoid end-of-year
                            penalties and large lump sum payments.
                          </p>
                        )}
                      </AlertDescription>
                    </Alert>
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    We couldn't find any transactions to analyze for quarterly
                    tax breakdown. Add transactions to see your quarterly tax
                    information.
                  </AlertDescription>
                </Alert>
              )}
            ...
            <CardContent className="p-6">
              ...
              {taxDeductibleTransactions.length > 0 ? (
                  ...
                  <div className="bg-green-50 rounded-lg p-4 mb-4">
                    <div className="flex justify-between items-center">
                      ...
                      <Badge className="bg-green-600">
                        {(
                          (taxDeductibleAmount / (incomeAmount || 1)) *
                          100
                        ).toFixed(1)}
                        % of Income
                      </Badge>
                  ...
                  <div className="border rounded-lg overflow-hidden">
                    ...
                    <div className="divide-y max-h-80 overflow-y-auto">
                      {taxDeductibleTransactions.map((tx) => (
                        <div
                          key={tx.id}
                          className="grid grid-cols-12 p-3 text-sm hover:bg-gray-50"
                        >
                          ...
                          <div className="col-span-3">
                            <div className="flex items-center">
                              <div
                                ...
                                style={{
                                  backgroundColor: tx.category?.color || "#888",
                                }}
                              />
                              {tx.category?.name || "Uncategorized"}
                            </div>
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    We couldn't find any potentially tax-deductible expenses in
                    your transactions. Try categorizing your expenses properly
                    to identify potential deductions.
                  </AlertDescription>
                </Alert>
              )}
              ...
              <div className="mt-6">
                <h4 className="font-medium mb-2">
                  Deductible Categories for {taxInfo.name}
                </h4>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-start gap-4 p-3 rounded-lg border border-gray-200">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                      Collect all income-related documents including W-2s,
                      1099s, or equivalent forms for your country.
                      {countryCode === "US" &&
                        " This includes salary, freelance, investments, and other income sources."}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-3 rounded-lg border border-gray-200">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                      Sort and categorize all business expense receipts,
                      especially those in tax-deductible categories. Keep both
                      digital and physical copies organized.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-3 rounded-lg border border-gray-200">
                  ...
                  <div>
                    <h4 className="font-medium">
                      Review Tax Deduction Eligibility
                    </h4>
                    <p className="text-sm text-gray-500 mt-1">
                      Verify which expenses qualify as tax deductions in{" "}
                      {taxInfo.name}. Review specific rules for home office,
                ...
                <div className="flex items-start gap-4 p-3 rounded-lg border border-gray-200">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                      Research available tax credits in {taxInfo.name} that you
                      might qualify for. These can significantly reduce your tax
                      liability.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-3 rounded-lg border border-gray-200">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                      Consider speaking with a tax professional familiar with{" "}
                      {taxInfo.name} tax laws. A professional can help maximize
              ...
              <Alert className="bg-blue-50 border-blue-200">
                ...
                <AlertDescription className="flex flex-col gap-2">
                  <p>
                    Access country-specific tax forms and guides for{" "}
                    {taxInfo.name}.
                  </p>
      ...
      <Dialog open={showTaxCalculator} onOpenChange={setShowTaxCalculator}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Based on your taxable income of {formatCurrency(taxableIncome)} in{" "}
              {taxInfo.name}.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-1 gap-4 mt-4">
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                ...
                <div className="text-2xl font-bold">
                  {formatCurrency(taxableIncome - estimatedTaxAmount)}
                </div>
              </div>
            </div>
          </div>
          ...
          <DialogFooter>
            <Alert className="bg-gray-50 border-gray-200 text-xs">
              ...
              <AlertDescription>
                This is an estimate only. Please consult a tax professional for
