import type { BudgetRecommendation } from "@/types/budgeting";
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700">
              Based on your spending patterns and financial situation, we've
              identified these potential opportunities to improve your financial
              health.
            </p>
          </div>
        </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-start gap-4">
              <div
                ...
                style={{
                  backgroundColor: recommendation.categoryColor
                    ? `${recommendation.categoryColor}20`
                    : "#f3e8ff",
                ...
                <div className="flex justify-between items-center">
                    ...
                    {recommendation.category && (
                      <div className="flex items-center">
                        <div
                          ...
                          style={{
                            backgroundColor:
                              recommendation.categoryColor || "#888",
                          }}
                        />
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-sm font-medium">
                      Potential Impact: {formatCurrencyValue(recommendation.impact)}
                    </span>
                  </div>
                </div>
              </div>
