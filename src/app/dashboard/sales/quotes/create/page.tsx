  ...
  return (
    <DashboardWrapper>
      <DashboardHeader
        ...
        text="This feature is temporarily unavailable. Please check back later."
      />
      <div className="space-y-6">
        {/* <QuoteForm onSubmit={handleSubmit} isSubmitting={isSubmitting} /> */}
        <p>The quote creation form is currently disabled while we resolve some issues. We apologize for the inconvenience.</p>
      </div>
    </DashboardWrapper>
  );
} 