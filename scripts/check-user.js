  ...
  try {
    ...
    if (listError) {
      ...
      if (user) {
        ...
        if (adminError) {
          console.error(
            "Error creating user with admin API:",
            adminError.message,
          );
          ...
          if (robustError) {
            ...
            if (
              robustError.message.includes("already exists") ||
              (robustData &&
                !robustData.success &&
              ...
              if (publicError) {
                ...
                console.log(
                  "Attempting to reset password with direct function...",
                );
                ...
                try {
                  ...
                  if (resetError) {
                    console.error(
                      "Error resetting password with function:",
                      resetError.message,
                    );
                  } else if (resetData) {
            ...
            if (newSignInError) {
              console.error(
                "Error signing in with new user:",
                newSignInError.message,
              );
            } else {
