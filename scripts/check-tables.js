...
async function checkTables() {
  ...
  if (accountsError) {
    ...
    console.log(`Accounts table exists with ${accounts ? accounts.length : 0} records for this user`);
  ...
  if (categoriesError) {
    ...
    console.log(`Categories table exists with ${categories ? categories.length : 0} records for this user`);
  ...
  if (transactionsError) {
    ...
    console.log(`Transactions table exists with ${transactions ? transactions.length : 0} records for this user`);
  ...
  if (invoicesError) {
    ...
    console.log(`Invoices table exists with ${invoices ? invoices.length : 0} records for this user`);
